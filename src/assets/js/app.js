    ...
    layout: {
        responsive: function(){
            ...
            if(!app.settings.responsiveState){
                ...
                if(window.innerWidth <= app.settings.breakpoints.md){
                    ...
                    if(pageAside){
                        pageContent.addClass("page-aside--minimized");
                        pageAside.addClass("page-aside--minimized");
                    }
        ...
        controls: function(){
            ...
            if(pageAsideHideButton.length > 0)
                app._controlPanelEvent(pageAsideHideButton,pageAside,"page-aside-animation-show","page-aside--minimized", $("#content"), app.settings.breakpoints.md, "group1");        
        ...
        aside_fixed: function(){
            ...
            if(pageContent.hasClass("page__content--w-aside-fixed")){
                ...
                $(window).on("scroll", app._debouncer( function(){
                    ...
                    //TODO: DA SE VIDI DALI TREBA, frla greska ova ???
